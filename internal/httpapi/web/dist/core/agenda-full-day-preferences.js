...
export function normalizeAgendaFullDay(value) {
...
function writeLocalPreference(enabled, ownerUserId) {
...
export function getAgendaFullDayPreference() {
    try {
        const user = getUser();
...
export function getAgendaTimelineMode() {
...
export function setAgendaFullDayPreference(enabled) {
...
export async function saveAgendaFullDayPreference(enabled) {
    const next = normalizeAgendaFullDay(enabled);
    const user = getUser();
...
export function hydrateAgendaFullDayFromServer(value) {
...
export async function loadAgendaFullDayPreferenceFromServer(fetchPreference) {
    const user = getUser();
    if (!user)
        return;
 ...
 */
export function onAgendaFullDayAuthUserChanged(userId) {
