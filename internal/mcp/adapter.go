...
type storeAPI interface {
	...
	CountTodosForBoardLane(ctx context.Context, projectID int64, columnKey string, tagFilter string, searchFilter string, assigneeFilter string, sprintFilter store.SprintFilter) (int, error)
